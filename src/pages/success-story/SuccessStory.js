        ...
        <div className=" successStoryContent">
          ...
          <div className="sscontent">
            <p className="p1">
              ...
              <br />
              <p>
                <span>Physical office setup :</span> <br /> RADEE8 facilitated the establishment of a dynamic and flexible workspace in a premium co-working space (in prime business district of Pune), accommodating Forescout’s initial team. This approach allowed for scalability as the team expanded. For physical set up in a co-working space, RADEE8 Advisory identified the selection of suitable location, negotiated lease agreements, and managed the interior set up, IT Infrastructure to meet Forescout’s specifications. A collaborative work environment was created, promoting employee well-being and fostering a sense of community among the team.
              </p>
              <br />
              <p>
